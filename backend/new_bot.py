...
# A note from KirbyDownB: None of this code was written by us. All of this code is from this repository. Any edits are just for fitting it to our application's needs
